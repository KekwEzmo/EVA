...
<head>
    <title>Code coverage report for bufferNode.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> bufferNode.ts</h1>
        <div class='clearfix'>
...
export function Uint8ArrayToString(arr: Uint8Array, encoding?: string): string {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (Buffer.isBuffer(arr)) {
<span class="cstat-no" title="statement not covered" >        return arr.toString(encoding);</span>
    } else {
...
export function stringToBuffer(input: string, encoding: string): ArrayBufferLike {
    ...
    return iso.byteLength === iso.buffer.byteLength
        ? <span class="branch-0 cbranch-no" title="branch not covered" >iso.buffer</span>
