 ...
 * @hidden
 */
export type ProcessRelatedChangeHandler = (objectId: string, event: ILiveEvent<any>) => void;
/**
 * @hidden
 */
export interface IContainerLiveObjectStoreEvents extends IEvent {
     ...
     */
    (event: "update", listener: (objectId: string, event: ILiveEvent<any>, local: boolean, processRelatedChange: ProcessRelatedChangeHandler) => void): void;
}
/**
 * @hidden
 */
