...
export interface IContainerRuntimeSignaler {
    ...
    off(event: "signal", listener: (message: IInboundSignalMessage, local: boolean) => void): this;
 ...
 */
export type UpdateSynchronizationState<TState> = (state: ILiveEvent<TState>, senderId: string, local: boolean) => Promise<boolean>;
/**
 ...
 */
export declare enum LiveDataObjectInitializeState {
    /**
