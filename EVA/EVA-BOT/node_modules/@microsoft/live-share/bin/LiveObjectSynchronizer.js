...
exports.LiveObjectSynchronizer = void 0;
/**
 * @internal
 * @hidden
 *
...
class LiveObjectSynchronizer {
     ...
     */
    constructor(id, runtime, liveRuntime) {
        this.id = id;
     ...
     */
    start(initialState, updateState, getLocalUserCanSend, shouldUpdateTimestampPeriodically = false) {
        return this.liveRuntime.objectManager.registerObject(this.id, this.runtime, initialState, {
            updateState,
            getLocalUserCanSend,
     ...
     */
    getLatestEvent() {
        return this.liveRuntime.objectManager.getLatestEventForObject(this.id);
    }
    /**
     ...
     * @returns the latest event sent, or undefined if there is none
     */
    getLatestEventForClient(clientId) {
        return this.liveRuntime.objectManager.getLatestEventForObjectClient(this.id, clientId);
    }
    /**
     ...
     */
    getEvents() {
        return this.liveRuntime.objectManager.getEventsForObject(this.id);
    }
    /**
     ...
     * @returns the event that was sent
     */
    sendThrottledEvent(data) {
        return this.liveRuntime.objectManager.sendThrottledEventForObject(this.id, data);
    }
}
exports.LiveObjectSynchronizer = LiveObjectSynchronizer;
//# sourceMappingURL=LiveObjectSynchronizer.js.map