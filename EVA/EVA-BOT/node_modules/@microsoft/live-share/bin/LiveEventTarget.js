...
exports.LiveEventTarget = void 0;
const LiveEventSource_1 = require("./LiveEventSource");
/**
 ...
 */
class LiveEventTarget extends LiveEventSource_1.LiveEventSource {
    /**
     ...
     */
    constructor(scope, eventName, listener) {
        super(scope, eventName);
        scope.onEvent(eventName, listener);
    }
}
exports.LiveEventTarget = LiveEventTarget;
//# sourceMappingURL=LiveEventTarget.js.map