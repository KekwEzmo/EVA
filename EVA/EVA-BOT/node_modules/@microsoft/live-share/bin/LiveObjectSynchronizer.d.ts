...
import { GetLocalUserCanSend, ILiveEvent, UpdateSynchronizationState } from "./interfaces";
/**
 * @internal
 * @hidden
 *
 ...
 */
export declare class LiveObjectSynchronizer<TState> {
    private readonly id;
     ...
     */
    constructor(id: string, runtime: IRuntimeSignaler, liveRuntime: LiveShareRuntime);
    /**
     ...
     */
    start(initialState: TState, updateState: UpdateSynchronizationState<TState>, getLocalUserCanSend: GetLocalUserCanSend, shouldUpdateTimestampPeriodically?: boolean): Promise<void>;
    /**
     ...
     * @returns the event that was sent
     */
    sendThrottledEvent<TState = any>(data: TState): Promise<ILiveEvent<TState>>;
}
//# sourceMappingURL=LiveObjectSynchronizer.d.ts.map