...
<head>
    <title>Code coverage report for bufferBrowser.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> bufferBrowser.ts</h1>
        <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >            throw new Error("invalid/unsupported encoding");</span>
        }
    }
}
&nbsp;
...
export function isArrayBuffer(obj: any): obj is ArrayBuffer {
    ...
    || (typeof maybe === "object"
        &amp;&amp; <span class="branch-2 cbranch-no" title="branch not covered" >maybe !== null</span>
        &amp;&amp; <span class="branch-3 cbranch-no" title="branch not covered" >typeof maybe.byteLength === "number"</span>
        &amp;&amp; <span class="branch-4 cbranch-no" title="branch not covered" >typeof maybe.slice === "function"</span>
        &amp;&amp; <span class="branch-5 cbranch-no" title="branch not covered" >maybe.byteOffset === undefined</span>
        &amp;&amp; <span class="branch-6 cbranch-no" title="branch not covered" >maybe.buffer === undefined)</span>;
}
&nbsp;
/**
...
&nbsp;
    ...
    static from(value, encodingOrOffset?, length?): IsoBuffer {
        ...
        } else <span class="missing-if-branch" title="else path not taken" >E</span>if (isArrayBuffer(value)) {
...
&nbsp;
    static fromArrayBuffer(arrayBuffer: ArrayBuffer, byteOffset?: number, byteLength?: number): IsoBuffer {
        const offset = <span class="branch-0 cbranch-no" title="branch not covered" >byteOffset </span>?? 0;
        const validLength = <span class="branch-0 cbranch-no" title="branch not covered" >byteLength </span>?? arrayBuffer.byteLength - offset;
...
&nbsp;
<span class="fstat-no" title="function not covered" >    static </span>isBuffer(obj: any): boolean {
<span class="cstat-no" title="statement not covered" >        throw new Error("unimplemented");</span>
    }
&nbsp;
    /**
...
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Thu Dec 22 2022 16:26:43 GMT+0000 (Coordinated Universal Time)
            </div>
        </div>
