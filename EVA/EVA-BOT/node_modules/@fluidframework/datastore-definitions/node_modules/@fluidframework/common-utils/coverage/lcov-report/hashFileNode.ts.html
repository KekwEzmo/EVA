...
<head>
    <title>Code coverage report for hashFileNode.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> hashFileNode.ts</h1>
        <div class='clearfix'>
 ...
 */
 export async function hashFile(
    file: IsoBuffer,
    algorithm: "SHA-1" | "SHA-256" = <span class="branch-0 cbranch-no" title="branch not covered" >"SHA-1",</span>
